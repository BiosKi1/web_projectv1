...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 26 Décembre 2016 à 17:38
...
INSERT INTO `users` (`id`, `type_user`, `acces`, `mdp`, `nom`, `prenom`, `adresse`, `ville`, `cp`, `mail`, `genre`, `couverture`) VALUES
(1, 1, NULL, '', 'slt', 'slt', '12 du slt', 'slt', 54707, 'slt@slt.fr', 'genre1', 'couver1'),
...
(6, 2, 2, '', 'tes23', 'test', 'tes', 'test', 2222, 'tes@test.ll', 'testmodif', 'gnioeg'),
(7, NULL, NULL, 'aze', 'zaeazeaze', 'azeaze', 'azeazrn', 'efoinafnae', 88888, 'afeaef@xn--gaegez-hc1c', 'Shônen', 'D:\\xampp\\tmp\\php4643.tmp'),
(8, NULL, NULL, 'aze', 'aze', 'aze', 'azeaze', 'azeazeza', 8888, 'aaa@gaa.f', 'Shônen', 'D:\\xampp\\tmp\\php8026.tmp'),
(9, NULL, NULL, 'nnoi', 'aze', 'tets', 'fnir', 'ooo', 8888, 'fneri@gm.fr', 'Shônen', 'D:\\xampp\\tmp\\phpE56A.tmp'),
(10, NULL, NULL, 'aze', 'aze', 'zae', 'aze', '888', 8888, 'zaeoaz@g.fr', 'Shônen', 'D:\\xampp\\tmp\\php6A8E.tmp'),
(11, NULL, NULL, 'aze', 'aze', 'aze', 'aze', 'aze', 888, 'azaa@gg.fr', 'Shônen', 'D:\\xampp\\tmp\\php8127.tmp'),
(12, NULL, NULL, 'aze', 'aze', 'aze', 'ettest', 'test', 8888, 'te@gej.fr', 'Shônen', 'D:\\xampp\\tmp\\php3868.tmp');
